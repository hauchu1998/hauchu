...
export default function Publication() {
    return (
        <div id="publish" className='w-full flex flex-col justify-center items-center'>
            <p className="mt-8 w-full font-bold text-3xl text-center underline underline-offset-2">PUBLICATION</p>
            <div className="mt-8 w-3/5">
                <ul className="w-full">
                    <li className='w-full grid grid-cols-3 gap-8 items-center'>
                        <img src={pubPng} />
                        <div className='col-span-2 flex flex-col items-start'>
                            <p className='font-bold text-gray-600 underline underline-offset-1 text-left'>Part-aware Measurement for Robust Multi-View Multi-Human 3D Pose Estimation and Tracking</p>
                            <p className='mt-1 text-left text-sm italic tracking-wide'>
                            ...
                            <p className='mt-1 text-left text-sm italic'>CVPR Workshop 2021</p>
